...
import {selectContactInfo, selectContactInfoLoading, selectContacts, selectFetchLoading} from "./contactsSlice";
        ...
        <>
          <div className="row p-4">
            ...
            <div className="col-6 ps-3">
              ...
              <p><EnvelopeFill/><span className="ms-2 text-primary text-decoration-underline">{contactInfo.email}</span></p>
            </div>
          </div>
          <div className="d-flex justify-content-center mb-2">
            <Link to="/edit-contact" className="btn btn-primary btn-lg me-2 px-5"><PencilFill className="me-2"/>Edit</Link>
            <button className="btn btn-danger btn-lg px-5"><TrashFill size={25} className="me-2"/>Delete</button>
          </div>
        </>
        }
      </Modal>
